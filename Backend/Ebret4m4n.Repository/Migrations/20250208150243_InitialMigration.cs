    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    HealthCareCenterId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    HealthCareCenterName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HealthCareCenters", x => x.HealthCareCenterId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ChildId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    HealthCarerCenterId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Certificates_HealthCareCenters_HealthCarerCenterId",
                        column: x => x.HealthCarerCenterId,
                        principalTable: "HealthCareCenters",
                        principalColumn: "HealthCareCenterId",
                        onDelete: ReferentialAction.NoAction);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HealthReportFiles", x => x.FilePath);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    DocesRequired = table.Column<int>(type: "int", nullable: false),
                    DocesTaken = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "3b0e2910-0fbb-489c-814f-e91acfbbd818", null, "AdminOfHC", null },
                    { "59ef1c3f-e8a6-47e2-850f-fca836908b0d", null, "Parent", null },
                    { "67d3e0ee-a207-4beb-a4d4-ce77f963e771", null, "Doctor", null },
                    { "ed74497e-ec09-467a-973d-5191b2307164", null, "AdminOfMinistryOfHealth", null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_HealthCareCenterId",
                table: "AspNetUsers",
                column: "HealthCareCenterId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Certificates_HealthCarerCenterId",
                table: "Certificates",
                column: "HealthCarerCenterId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HealthReportFiles_ChildId",
