...
namespace Ebret4m4n.Repository.Migrations
{
    ...
    [Migration("20250301154047_splitAdminRolesToCitAdminAndGoverorateAdminAndAddTables")]
    partial class splitAdminRolesToCitAdminAndGoverorateAdminAndAddTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Ebret4m4n.Entities.Models.HealthCareCenter", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            HealthCareCenterId = new Guid("071b99da-d916-4a3b-af54-f799a686660b"),
                            City = "بني مزار",
                            FirstDay = "Monday",
                            Governorate = "المنيا",
                        ...
                        new
                        {
                            HealthCareCenterId = new Guid("33708959-1091-42fe-937e-c92b67e59934"),
                            City = "بني مزار",
                            FirstDay = "Sunday",
                            Governorate = "المنيا",
                        ...
                        new
                        {
                            HealthCareCenterId = new Guid("cfcaae8a-bcda-4583-9481-dc9016c52a4f"),
                            City = "المنيا",
                            FirstDay = "Saturday",
                            Governorate = "المنيا",
                        ...
                        new
                        {
                            HealthCareCenterId = new Guid("b8e0b40b-6440-4fc6-bbab-7f823a9325b9"),
                            City = "مغاغا",
                            FirstDay = "Sunday",
                            Governorate = "المنيا",
                        ...
                        new
                        {
                            HealthCareCenterId = new Guid("218c1c44-4e58-4529-905e-41bd845a2a6f"),
                            City = "العدوي",
                            FirstDay = "Sunday",
                            Governorate = "المنيا",
                        ...
                        new
                        {
                            HealthCareCenterId = new Guid("facf0c6c-6e01-4558-af73-3b30655318e7"),
                            City = "الجيزه",
                            FirstDay = "Sunday",
                            Governorate = "الجيزه",
                        ...
                        new
                        {
                            HealthCareCenterId = new Guid("64a2982b-d1b3-4248-ad4f-8ca4d8a39976"),
                            City = "عين شمس",
                            FirstDay = "Sunday",
                            Governorate = "القاهره",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "df51f641-df73-4f92-8054-8a49c478f205",
                            Name = "doctor",
                            NormalizedName = "DOCTOR"
                        },
                        new
                        {
                            Id = "ca6dab54-bd3d-4839-89b6-2403fb4249c4",
                            Name = "organizer",
                            NormalizedName = "ORGANIZER"
                        },
                        new
                        {
                            Id = "8e22ec3e-f1a5-4cdd-b251-d35775da1291",
                            Name = "governorateAdmin",
                            NormalizedName = "GOVERNORATEADMIN"
                        },
                        new
                        {
                            Id = "191c486e-4213-4a1f-976c-85733ab7c7c5",
                            Name = "cityAdmin",
                            NormalizedName = "CITYADMIN"
                        },
                        new
                        {
                            Id = "74190ebc-ce16-4e92-b6a2-6c62399bfcf5",
                            Name = "admin",
