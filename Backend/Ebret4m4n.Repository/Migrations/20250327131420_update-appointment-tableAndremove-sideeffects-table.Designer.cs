...
namespace Ebret4m4n.Repository.Migrations
{
    ...
    [Migration("20250327131420_update-appointment-tableAndremove-sideeffects-table")]
    partial class updateappointmenttableAndremovesideeffectstable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Ebret4m4n.Entities.Models.HealthCareCenter", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            HealthCareCenterId = new Guid("2a7d506e-8bf2-4a18-8cd0-a9eee4c75890"),
                            City = "بني مزار",
                            FirstDay = "Monday",
                            Governorate = "المنيا",
                        ...
                        new
                        {
                            HealthCareCenterId = new Guid("6759c327-e243-43d9-a84b-32d847a4d267"),
                            City = "بني مزار",
                            FirstDay = "Sunday",
                            Governorate = "المنيا",
                        ...
                        new
                        {
                            HealthCareCenterId = new Guid("7fdc64ec-ebc4-498d-b3d1-8b30a73c1d01"),
                            City = "المنيا",
                            FirstDay = "Saturday",
                            Governorate = "المنيا",
                        ...
                        new
                        {
                            HealthCareCenterId = new Guid("94d7a785-f17e-4f98-a0ff-fc36d75fcd7d"),
                            City = "مغاغا",
                            FirstDay = "Sunday",
                            Governorate = "المنيا",
                        ...
                        new
                        {
                            HealthCareCenterId = new Guid("bc49ce92-a4a2-45f7-98e0-74aedc967622"),
                            City = "العدوي",
                            FirstDay = "Sunday",
                            Governorate = "المنيا",
                        ...
                        new
                        {
                            HealthCareCenterId = new Guid("8b2c98f2-ff92-4929-8927-7646b0138cd8"),
                            City = "الجيزه",
                            FirstDay = "Sunday",
                            Governorate = "الجيزه",
                        ...
                        new
                        {
                            HealthCareCenterId = new Guid("bd62e348-7184-4848-968c-fe11f6639ed0"),
                            City = "عين شمس",
                            FirstDay = "Sunday",
                            Governorate = "القاهره",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "88dd76f5-7479-44db-b051-4f8152fb546c",
                            Name = "parent",
                            NormalizedName = "PARENT"
                        },
                        new
                        {
                            Id = "2ea04679-3639-4b33-90cd-5be55dc13822",
                            Name = "doctor",
                            NormalizedName = "DOCTOR"
                        },
                        new
                        {
                            Id = "1a645924-052a-4646-b998-c7013ab50bcb",
                            Name = "organizer",
                            NormalizedName = "ORGANIZER"
                        },
                        new
                        {
                            Id = "1bb3a8bd-a507-4db1-8e6e-a5bea6044d4c",
                            Name = "governorateAdmin",
                            NormalizedName = "GOVERNORATEADMIN"
                        },
                        new
                        {
                            Id = "4e741bc6-635b-43be-873e-32cdfec53bd9",
                            Name = "cityAdmin",
                            NormalizedName = "CITYADMIN"
                        },
                        new
                        {
                            Id = "ff0a1ceb-ced4-46b4-a4c3-17939ac4b027",
                            Name = "admin",
