...
namespace Ebret4m4n.Repository.Migrations
{
    ...
    [Migration("20250306152949_modifyTheInvenrotyTableAndAddOrdersTable")]
    partial class modifyTheInvenrotyTableAndAddOrdersTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Ebret4m4n.Entities.Models.HealthCareCenter", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            HealthCareCenterId = new Guid("249c9384-3e76-4729-8cb9-8840a5f6c191"),
                            City = "بني مزار",
                            FirstDay = "Monday",
                            Governorate = "المنيا",
                        ...
                        new
                        {
                            HealthCareCenterId = new Guid("dc492686-6a33-428e-bdba-c2524ac7e44a"),
                            City = "بني مزار",
                            FirstDay = "Sunday",
                            Governorate = "المنيا",
                        ...
                        new
                        {
                            HealthCareCenterId = new Guid("8351d9b4-1c0d-4a1c-b253-3f7cc78d17e9"),
                            City = "المنيا",
                            FirstDay = "Saturday",
                            Governorate = "المنيا",
                        ...
                        new
                        {
                            HealthCareCenterId = new Guid("9c69ca87-1910-4f23-9b54-37c8d440ef78"),
                            City = "مغاغا",
                            FirstDay = "Sunday",
                            Governorate = "المنيا",
                        ...
                        new
                        {
                            HealthCareCenterId = new Guid("71230496-1302-45c5-9487-f60863f1907c"),
                            City = "العدوي",
                            FirstDay = "Sunday",
                            Governorate = "المنيا",
                        ...
                        new
                        {
                            HealthCareCenterId = new Guid("e3778f08-e87e-4389-8ea4-4a73c004288a"),
                            City = "الجيزه",
                            FirstDay = "Sunday",
                            Governorate = "الجيزه",
                        ...
                        new
                        {
                            HealthCareCenterId = new Guid("af21e432-161e-419f-9b11-be8d4d8c0cb3"),
                            City = "عين شمس",
                            FirstDay = "Sunday",
                            Governorate = "القاهره",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "a1ee9400-805c-4bb8-80fa-10ad1d146fb8",
                            Name = "parent",
                            NormalizedName = "PARENT"
                        },
                        new
                        {
                            Id = "18b49dbf-8208-4faa-8c4f-26f13eae874a",
                            Name = "doctor",
                            NormalizedName = "DOCTOR"
                        },
                        new
                        {
                            Id = "1207aba1-90b0-41b1-b693-ac35e1f5b5e9",
                            Name = "organizer",
                            NormalizedName = "ORGANIZER"
                        },
                        new
                        {
                            Id = "32713898-08ac-48eb-bf84-3611bcfe5677",
                            Name = "governorateAdmin",
                            NormalizedName = "GOVERNORATEADMIN"
                        },
                        new
                        {
                            Id = "19fb137e-d72f-4a88-a218-b1c0fd07d966",
                            Name = "cityAdmin",
                            NormalizedName = "CITYADMIN"
                        },
                        new
                        {
                            Id = "d1f4b38e-dc2b-424c-a815-480bd796cbc1",
                            Name = "admin",
